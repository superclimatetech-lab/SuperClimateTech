...
import { ShortTermForecast } from '../components/Forecast/ShortTermForecast';
import { WeatherMap } from '../components/Map/WeatherMap';
import { useWeather } from '../context/WeatherContext';

export const ShortTermPage = () => {
    ...
    <DashboardLayout>
      <div className="space-y-3 sm:space-y-4 h-full flex flex-col">
        ...
        <div className="flex items-center justify-between flex-shrink-0">
          <h1 className="text-2xl sm:text-3xl font-bold text-gray-900">Short-Term Forecast</h1>
          <button
        ...
        {showMap ? (
          ...
          <div className="flex-1 min-h-0 overflow-y-auto">
            {selectedLocation ? (
              <ShortTermForecast locationId={selectedLocation.id} />
            ) : (
